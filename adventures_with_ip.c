...
void menu(){
	...
	xil_printf("Enter 's' to stream pure audio, 'm' to use a moving average filter and "
			"'f' to use a fir filter\r\n");
	xil_printf("----------------------------------------\r\n");
...
//		break;
	case 'm':
		printf("ENTERING MOVING AVERAGE FILTER OPERATION");
		xil_printf("Press 'q' to return to the main menu\r\n");
		moving_avg();
		break;
	case 'f':
		printf("ENTERING FIR FILTER OPERATION");
		xil_printf("Press 'q' to return to the main menu\r\n");
		fir();
		break;
	case 'i':
