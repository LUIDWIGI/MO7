...
void LineinLineoutConfig() {
	...
	AudioWriteToReg(R19_ADC_CONTROL, 0b0110011);
	AudioWriteToReg(R36_DAC_CONTROL_0, 0x3);
	...
	AudioWriteToReg(R4_RECORD_MIXER_LEFT_CONTROL_0, 0b1011011);
	AudioWriteToReg(R5_RECORD_MIXER_LEFT_CONTROL_1, 0b01001);//0 dB gain
	AudioWriteToReg(R6_RECORD_MIXER_RIGHT_CONTROL_0, 0x01);
	AudioWriteToReg(R7_RECORD_MIXER_RIGHT_CONTROL_1, 0x01);//0 dB gain
